...
switch($_GET['status']) {
  case 'success':
    $title = "La transaccion se ha efectuado correctamente";
    break
  case 'pending':
    $title = "La transaccion quedo pendiente";
    break
  case 'failure':
    $title = "La transaccion ha fallado";
    break
  default;
        ...
        <div class="as-search-wrapper" role="main">
            ...
            <div class="as-search-results as-filter-open as-category-landing as-desktop" id="as-search-results">
                ...
                <div id="accessories-tab" class="as-accessories-details">
                    <div class="as-accessories" id="as-accessories" style="height: 300px;">
                        <h1 class="pd-billboard-header pd-util-compact-small-18"><?php $title;?></h1>
                        <div><?php echo $mensaje; ?></div>
                        <a href="./index.php" title="Volver" class="button">Volver</a>
                    </div>
                </div>
            </div>
        </div>
