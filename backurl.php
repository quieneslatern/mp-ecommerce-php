...
$mensaje .= "</ul>";
                                <h3 style="text-align:center margin-top:100px"; >La transaccion se ha efectuado correctamente</h3>
            ...
            <div class="as-search-results as-filter-open as-category-landing as-desktop" id="as-search-results">
                ...
                <div id="accessories-tab" class="as-accessories-details">
                    <div class="as-accessories" id="as-accessories" style="height: 300px;">
                        <h1 class="pd-billboard-header pd-util-compact-small-18">asdas</h1>
